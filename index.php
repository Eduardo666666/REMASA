    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tiendaTorno.php"><img src="./assets/img/productoVista-05.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Torno</h5>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tiendaDireccion.php"><img src="./assets/img/productoVista-06.jpg" class="rounded-circle img-fluid border"></a>
            ...
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tiendaFiltracion.php"><img src="./assets/img/productoVista-07.jpg" class="rounded-circle img-fluid border"></a>
            ...
            <div class="row text-light mb-4" style="background-color: #1A2B50;">
                ...
                <div class="col-auto me-auto">
                    ...
                    <li class="list-inline-item border border-light rounded-circle text-center">
                        ...
                        <li class="list-inline-item border border-light rounded-circle text-center">
                            <a class="text-light text-decoration-none" href="https://www.facebook.com/p/Refaccionaria-Miguel-De-Autobuses-Sa-De-Cv-100054638641322/" target="_blank"><i class="fab fa-facebook-f fa-lg fa-fw"></i></a>
                        </li>
                        <li class="list-inline-item border border-light rounded-circle text-center">
